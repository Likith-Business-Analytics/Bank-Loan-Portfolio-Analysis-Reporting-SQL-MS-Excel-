...
-<a herf="https://github.com/Likith-Business-Analytics/Bank-Loan-Portfolio-Analysis-Reporting-SQL-MS-Excel-/blob/main/BANK%20LOAN%20DATASET.xlsx">Dataset</a>
1. SQL: Used for the precise calculation of all required KPIs, including complex MTD/PMTD and Good/Bad Loan aggregations. All source queries are provided in the SQLQuery1.sql and BANK LOAN REPORT SQL QUERY DOCUMENT.docx files.
2. Microsoft Excel: Employed for generating dynamic dashboards, visual analysis, and critically, using Pivot Tables to validate and verify all final report figures against the raw outputs generated by the SQL queries.
