...
•	SQL: Used for the precise calculation of all required KPIs, including complex MTD/PMTD and Good/Bad Loan aggregations. All source queries are provided in the SQLQuery1.sql and BANK LOAN REPORT SQL QUERY DOCUMENT.docx files.
•	Microsoft Excel: Employed for generating dynamic dashboards, visual analysis, and critically, using Pivot Tables to validate and verify all final report figures against the raw outputs generated by the SQL queries.

Key Performance Indicators (KPIs) 
Dashboard 1: Summary & Portfolio Health KPIs
This section focuses on aggregate performance, risk assessment, and month-over-month comparisons.
Core Financial and Application Metrics
These KPIs are tracked overall, Month-to-Date (MTD), and with Month-over-Month (MoM) comparison:
